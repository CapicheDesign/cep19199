		...
		<section class="clearfix">
			...
			<div class="right-col" role="main">
				...
				<div class="content-inner m-t-m m-b-m">
					...
					<p>There was continued work with international and New Zealand-based experts to advance the regeneration plan. Valuable insights were gained from a wide range of stakeholders including customers, the community, local and central government.</p>
