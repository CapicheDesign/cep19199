...
<section data-index=5 id="focus">
    <a href="#" id="focus-panel-1" class="panel__home panel__half panel__half__left">
        ...
        <a href="#" id="focus-panel-3" class="panel__home panel__quarter panel__quarter__top panel__quarter__right">
            <div class="panel--content">
